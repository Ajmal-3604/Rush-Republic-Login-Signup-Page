...
export default function ClientServicingHome() {
  const [user, setUser] = useState(null);
  const [error, setError] = useState('');

  useEffect(() => {
    api
      .get('/client-servicing/')
  ...
  return (
    <div className="rr-page">
      ...
      <div className="rr-page__body">
        <div className="rr-page__eyebrow">Client-Servicing</div>
        <h1 className="rr-page__title">This is Client-Servicing Home Page</h1>
